"""Common CLI for Residual engine runners."""
...
from .spec import DEFAULT_HOST, RESIDUAL_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging residual runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=RESIDUAL_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=RESIDUAL_ROOT / "manifest.yaml")
