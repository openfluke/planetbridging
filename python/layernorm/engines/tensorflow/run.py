#!/usr/bin/env python3
"""TensorFlow LayerNorm bedrock (numpy reference forward)."""
...
def train_or_load(*, model: ModelSpec, manifest: Manifest, data: dict) -> tuple[dict[str, np.ndarray], bool]:
    ...
    if not skipped:
        ...
        write_complete(PLANET, model.id, REQUIRED, tensorflow.__version__)
...
if __name__ == "__main__":
    raise SystemExit(run_planet(PLANET, tensorflow.__version__, handler))
