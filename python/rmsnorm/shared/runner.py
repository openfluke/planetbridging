"""Common CLI for RMSNorm engine runners."""
...
from .spec import DEFAULT_HOST, RMSNORM_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging rmsnorm runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=RMSNORM_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=RMSNORM_ROOT / "manifest.yaml")
