#!/usr/bin/env python3
"""TensorFlow SwiGLU bedrock (numpy reference forward)."""
...
from shared.swiglu_forward import loom_swiglu_forward  # noqa: E402
...
def handler(*, model: ModelSpec, manifest: Manifest, data: dict, models_dir: Path, host: str = DEFAULT_HOST, skip_loom: bool = False):
    ...
    native = loom_swiglu_forward(x_test, **weights)[:, :out_dim]
    results = [
        VariantResult(
            planet=PLANET,
            stage="native",
