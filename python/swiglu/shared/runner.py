"""Common CLI for SwiGLU engine runners."""
...
from .spec import DEFAULT_HOST, SWIGLU_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging swiglu runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=SWIGLU_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=SWIGLU_ROOT / "manifest.yaml")
