"""Common CLI for mixer engine runners."""
...
from .spec import DEFAULT_HOST, MIXER_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging mixer runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=MIXER_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=MIXER_ROOT / "manifest.yaml")
