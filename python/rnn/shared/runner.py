"""Common CLI for RNN engine runners."""
...
from .spec import DEFAULT_HOST, RNN_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging rnn runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=RNN_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=RNN_ROOT / "manifest.yaml")
