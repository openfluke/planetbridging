"""Common CLI for Embedding engine runners."""
...
from .spec import DEFAULT_HOST, EMBEDDING_ROOT
from .variants import VariantResult


def build_parser(planet: str) -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description=f"planetbridging embedding runner ({planet})")
    p.add_argument("--host", default=DEFAULT_HOST)
    p.add_argument("--models-dir", type=Path, default=EMBEDDING_ROOT / "models")
    p.add_argument("--manifest", type=Path, default=EMBEDDING_ROOT / "manifest.yaml")
