"""Load/save Loom-format Embedding weights."""
...
from .embedding_forward import init_embedding_weights
...
def init_or_load_weights(
    ...
    *,
    ...
    weights = init_embedding_weights(model.vocab_size, model.embed_dim, model_seed(manifest, model))
